...
public partial class LanguageConfig
{
    ...
    public LanguageConfig(string _content)
    {
        try
        {
    ...
    public static LanguageConfig Get(int _id)
    {
        ...
        {
            config = configs[_id] = new LanguageConfig(rawDatas[_id]);
            rawDatas.Remove(_id);
        }
    ...
    public static void Init()
    {
        ...
        ThreadPool.QueueUserWorkItem((object _object) =>
        {
			...
			DebugEx.LogFormat("加载结束LanguageConfig：{0}",   DateTime.Now);
        });
    }
