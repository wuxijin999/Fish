...
public static class ColorUtility
{
    ...
    static ColorUtility()
    {
        ...
        qualityColors = new string[] {
         StringUtility.Contact("<color=#", ColorToInt16String(white), ">{0}</color>"),
         StringUtility.Contact("<color=#", ColorToInt16String(green), ">{0}</color>"),
         StringUtility.Contact("<color=#", ColorToInt16String(blue), ">{0}</color>"),
         StringUtility.Contact("<color=#", ColorToInt16String(purple), ">{0}</color>"),
         StringUtility.Contact("<color=#", ColorToInt16String(orange), ">{0}</color>"),
         StringUtility.Contact("<color=#", ColorToInt16String(red), ">{0}</color>"),
         StringUtility.Contact("<color=#", ColorToInt16String(pink), ">{0}</color>"),
        };
    }
    ...
    static string ColorToInt16String(Color _color)
    {
        ...
        return StringUtility.Contact(r1, r2, g1, g2, b1, b2, a1, a2);
    }
}
